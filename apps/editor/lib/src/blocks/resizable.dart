...
extension AligmentIncludes on Alignment {
  bool get containsLeft => [Alignment.centerLeft, Alignment.bottomLeft, Alignment.topLeft].contains(this);

  bool get containsRight => [Alignment.centerRight, Alignment.bottomRight, Alignment.topRight].contains(this);

  bool get containsTop => [Alignment.topLeft, Alignment.topRight, Alignment.topCenter].contains(this);

  bool get containsBottom => [Alignment.bottomRight, Alignment.bottomLeft, Alignment.bottomCenter].contains(this);
}
...
class Resizable extends HookWidget {
  ...
  void onDragUpdate(ObjectRef<ResizeState?> ref, Alignment handle, DragUpdateDetails details) {
  ...
  void onDragEnd(ObjectRef<ResizeState?> ref, Alignment handle, DraggableDetails details) {
    ref.value = null;
  }
}
...
class ResizableHandle extends HookWidget {
  ...
  MouseRegion buildContent(ValueNotifier<bool> hover, ValueNotifier<bool> dragging) {
    return MouseRegion(
      onEnter: (e) {
        hover.value = true;
      },
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: (hover.value || dragging.value) ? Colors.black.withAlpha(60) : Colors.black.withAlpha(30),
